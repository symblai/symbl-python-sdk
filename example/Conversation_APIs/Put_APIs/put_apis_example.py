...
conversation = Text.process(payload=payload)

#fectch conversation_id using conversaton object
Conversation_id = conversation.get_conversation_id()

#get the list of members from response of get_members
list_of_members = conversation.get_members().members

members_id = []

#store members id in list
...
print(conversation.put_members(id1,parameters= param))
'''
payload={
    "speakerEvents" : [
    {
...
print(conversation.put_speakers_events(parameters= payload))
'''
