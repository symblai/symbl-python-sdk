...
class ConversationsApiTest(unittest.TestCase):
    ...
    def test_delete_conversation_should_succeed_given_valid_conversation_id(self):
        ...
        with patch("symbl.AuthenticationToken.get_api_client", Mock(return_value="None")), patch("symbl_rest.ConversationsApi.delete_conversation_by_conversation_id", Mock(return_value=demo_response)):
            self.assertEqual(
                demo_response, conversations_api.delete_conversation("6549352073920512"))
    ...
    def test_get_formatted_transcript_should_succeed_given_valid_conversation_id(self):
        ...
        with patch("symbl.AuthenticationToken.get_api_client", Mock(return_value="None")), patch("symbl_rest.ConversationsApi.get_formatted_transcript_by_conversation_id", Mock(return_value=demo_response)):
            self.assertEqual(
                demo_response, conversations_api.get_formatted_transcript("6549352073920512", parameters=payload))
