from symbl import Conversations, Text
...
conversation_id = "6586329228902400" #update with your conversation id

conversation = Text.append(payload=payload, conversation_id=conversation_id)
